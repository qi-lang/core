...
pub mod number {
    ...
    pub const TWO: &'static str = "2";
    pub const THREE: &'static str = "3";
    pub const FOUR: &'static str = "4";
    pub const FIVE: &'static str = "5";
    pub const SIX: &'static str = "6";
    pub const SEVEN: &'static str = "7";
    pub const EIGHT: &'static str = "8";
