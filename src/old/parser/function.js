...
var params = P.between(Symbols.LeftParenthesis)(Symbols.RightParenthesis)(P.sepBy(spacey_1["default"](Symbols.Comma))(P.sequenceOf([
    ...
    // default params
    P.possibly(P.takeRight(spacey_1["default"](Symbols.DoubleBackSlash))(P.recursiveParser(function () { return type_1["default"].Any; }))),
])
    .map(function (x) { return new params_1["default"](x[0], (x[1])); })));
var Function = P.sequenceOf([
    ...
    .map(function (x) { return new function_1["default"](x[0], x[1], x[2]); });
