...
(function (Lambda) {
    ...
    (function (Parser) {
        let Params;
        (function (Params) {
            const simple = Arc.sepBy(helper_1.Helper.Spacing.between(symbols_1.Symbols.Parser.COMMA))(helper_1.Helper.Spacing.between(ident_1.Ident.Parser.object));
            const withParenthesis = Arc.between(helper_1.Helper.Spacing.between(symbols_1.Symbols.Parser.Parenthesis.LEFT))(helper_1.Helper.Spacing.between(symbols_1.Symbols.Parser.Parenthesis.RIGHT))(helper_1.Helper.Spacing.between(simple));
            Params.object = Arc.choice([
                withParenthesis,
                simple,
            ]);
        })(Params || (Params = {}));
        const body = Arc.recursiveParser(() => Arc.many(Arc.choice([
            // PTypes.Any,
        ...
        Parser.object = Arc.sequenceOf([
            Arc.between(symbols_1.Symbols.Parser.FN)(symbols_1.Symbols.Parser.Block.END)(Arc.sequenceOf([
                Arc.takeLeft(helper_1.Helper.Spacing.between(Params.object))(symbols_1.Symbols.Parser.Arrow.Thin.RIGHT),
                helper_1.Helper.Spacing.between(body),
            ])),
        ]);
